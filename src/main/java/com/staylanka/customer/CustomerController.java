...
public class CustomerController {
    ...
    public String customers(@RequestParam(defaultValue = "") String q,
    ...
    public String customer(@PathVariable Long id, Model model) {
        model.addAttribute("profile", customerService.get(id));
    ...
    public String toggleActive(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("success", "Customer account status updated.");
